 ...
 * account-service timeout, INSUFFICIENT_FUNDS, fraud rule bloklashi va h.k. Har birini alohida
...
public class TransactionFailedEvent implements TransactionEvent {
    ...
    String failureCode;      // masalan: "INSUFFICIENT_FUNDS", "ACCOUNT_FROZEN", "ACCOUNT_SERVICE_TIMEOUT"
